...
if (typeof require === 'function') {
    ...
    var PingMessage = require('./pingmessage');
    var PongMessage = require('./pongmessage');
    var AchievementUnlockedMessage = require('./achievementunlockedmessage');
    var HandshakeMessage = require('./handshakemessage');
    var HandshakeResultMessage = require('./handshakeresultmessage');
    var AuthenticateMessage = require('./authenticatemessage');
    var AuthenticateResultMessage = require('./authenticateresultmessage');
    var DeauthenticateMessage = require('./deauthenticatemessage');
    var DeauthenticateResultMessage = require('./deauthenticateresultmessage');
    var ChatActivityMessage = require('./chatactivitymessage');
    var GlobalChatMessage = require('./globalchatmessage');
    var ChatMessage = require('./chatmessage');
    var UserChatMessage = require('./userchatmessage');
    var ReportChatMessage = require('./reportchatmessage');
    var ReportChatResultMessage = require('./reportchatresultmessage');
    var UndoChatReportMessage = require('./undochatreportmessage');
    var UndoChatReportResultMessage = require('./undochatreportresultmessage');
    var SystemChatMessage = require('./systemchatmessage');
    var CreateGameResultMessage = require('./creategameresultmessage');
    var CreateGameMessage = require('./creategamemessage');
    var CountDownMessage = require('./countdownmessage');
    var GameStateMessage = require('./gamestatemessage');
    var JoinGameMessage = require('./joingamemessage');
    var JoinGameResultMessage = require('./joingameresultmessage');
    var LeaveGameMessage = require('./leavegamemessage');
    var LeaveGameResultMessage = require('./leavegameresultmessage');
    var CancelLeaveGameMessage = require('./cancelleavegamemessage');
    var CancelLeaveGameResultMessage = require('./cancelleavegameresultmessage');
    var ListGamesMessage = require('./listgamesmessage');
    var ListGamesResultMessage = require('./listgamesresultmessage');
    var RequestMazeMessage = require('./requestmazemessage');
    var RequestMazeResultMessage = require('./requestmazeresultmessage');
    var TankDestroyedMessage = require('./tankdestroyedmessage');
    var TankKilledMessage = require('./tankkilledmessage');
    var ProjectileDestroyedMessage = require('./projectiledestroyedmessage');
    var ProjectileTimeoutMessage = require('./projectiletimeoutmessage');
    var CollectibleDestroyedMessage = require('./collectibledestroyedmessage');
    var WeaponDestroyedMessage = require('./weapondestroyedmessage');
    var UpgradeDestroyedMessage = require('./upgradedestroyedmessage');
    var CounterDestroyedMessage = require('./counterdestroyedmessage');
    var ZoneDestroyedMessage = require('./zonedestroyedmessage');
    var RoundEndedMessage = require('./roundendedmessage');
    var RoundCreatedMessage = require('./roundcreatedmessage');
    var RoundStartedMessage = require('./roundstartedmessage');
    var StakesMessage = require('./stakesmessage');
    var RoundStateMessage = require('./roundstatemessage');
    var CelebrationStartedMessage = require('./celebrationstartedmessage');
    var TankStateMessage = require('./tankstatemessage');
    var PlayerKickedMessage = require('./playerkickedmessage');
    var PlayersBannedMessage = require('./playersbannedmessage');
    var PlayersUnbannedMessage = require('./playersunbannedmessage');
    var PlayerUpdatedMessage = require('./playerupdatedmessage');
    var ShutdownMessage = require('./shutdownmessage');
    var ContentUpdatedMessage = require('./contentupdatedmessage');
    ...
    var PlayerKick = require('./playerkick');
    var ChatPost = require('./chatpost');
    var SystemChatPost = require('./systemchatpost');
    var AchievementUnlock = require('./achievementunlock');
