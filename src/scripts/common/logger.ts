...
export const info = (...args: unknown[]): void => {
	console.log('\x1b[36m%s\x1b[0m', newTimestamp(), separator, ...transformArgs(args));
};
...
export const warn = (...args: unknown[]): void => {
	console.warn('\x1b[33m%s\x1b[0m', newTimestamp(), separator, ...transformArgs(args));
};
...
export const error = (...args: unknown[]): void => {
	console.error('\x1b[31m%s\x1b[0m', newTimestamp(), separator, ...transformArgs(args));
};
